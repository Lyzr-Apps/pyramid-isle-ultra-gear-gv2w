...
const QUICK_CHIPS: Record<string, string[]> = {
  ...
  battles: ['Battle Rules', 'Duel Rules', 'Coliseum Battles', 'Element Badges', 'Summoning System', 'Monster Box', 'XP System', 'Buddy System'],
...
const CHIP_PROMPTS: Record<string, Record<string, string>> = {
  world: {
    'Earth Town': 'Design Earth Town - the starting town on the circular island with Gothic stone buildings, a professor\'s lab, player house, rival house, temple, store, and the Earth Coliseum where the Earth Top Battler guards the Earth Badge. Earthy terrain with ancient ruins and nature paths.',
    'Light Town': 'Design Light Town - a radiant town bathed in golden sunlight with crystal spires, celestial architecture, shimmering pathways, and the Light Coliseum where the Light Top Battler guards the Light Badge.',
    'Fire Town': 'Design Fire Town - a volcanic town built from lava rock with magma rivers, obsidian fortresses, fiery wasteland terrain, and the Fire Coliseum where the Fire Top Battler guards the Fire Badge.',
    'Dark Town': 'Design Dark Town - a shadowy cave-based town shrouded in perpetual twilight with gothic architecture, eerie underground passages, and the Dark Coliseum where the Dark Top Battler guards the Dark Badge.',
    'Water Town': 'Design Water Town - a coastal town with cliff ruins, underwater grottos, coral structures, tidal waterfalls, and the Water Coliseum where the Water Top Battler guards the Water Badge.',
    'Wind Town': 'Design Wind Town - a sky-high town on the upper reaches of the island with wind-carved cliffs, cloud bridges, aerial towers, and the Wind Coliseum where the Wind Top Battler guards the Wind Badge.',
  ...
  battles: {
    ...
    'Coliseum Battles': 'Design the Coliseum Top Battler system. Each of the 6 towns has a Coliseum with a Top Battler — the strongest duelist of that element. Design the escalating difficulty, boss fight mechanics, and how defeating the Top Battler works using full Rush Duel rules.',
    'Element Badges': 'Design the Element Badge progression system. After defeating a town\'s Top Battler in the Coliseum, the player earns that town\'s Element Badge (Earth Badge, Light Badge, Fire Badge, Dark Badge, Water Badge, Wind Badge). Collecting all 6 badges unlocks access to Divine City. Design badge abilities, display, and progression rewards.',
  },
  story: {
    'Earth Town Intro': 'Write the opening chapter set in Earth Town where the protagonist receives their first monster partner.',
    'Light Town': 'Write the Light Town chapter where the protagonist challenges the Light Coliseum, defeats the Light Top Battler, and earns the Light Badge.',
    'Fire Town': 'Write the Fire Town chapter with volcanic trials and the fierce Fire Top Battler boss duel in the Fire Coliseum to earn the Fire Badge.',
    'Dark Town': 'Write the Dark Town chapter exploring the shadow realm and confronting the Dark Top Battler in the Dark Coliseum to earn the Dark Badge.',
    'Water Town': 'Write the Water Town chapter with underwater exploration and the Water Top Battler challenge in the Water Coliseum to earn the Water Badge.',
    'Wind Town': 'Write the Wind Town chapter set in the sky ruins with aerial challenges and the Wind Top Battler duel in the Wind Coliseum to earn the Wind Badge.',
    'Orb Quest': 'Write the main quest arc where the protagonist must defeat all 6 Top Battlers in their Coliseums, collect all 6 Element Badges, and unlock the path to Divine City.',
